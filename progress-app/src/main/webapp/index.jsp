...
<head>
  ...
  <style>
    .warn { background: #fff3cd; color: #856404; padding: .5rem .75rem; border-radius: 4px; margin: .5rem 0; }
  </style>
  </head>
    ...
    <c:otherwise>
      <div class="card" style="max-width: 420px;">
        ...
        <div class="card-body">
          ...
          <c:if test="${not empty requestScope.authWarning}">
            <div class="warn">${requestScope.authWarning}</div>
          </c:if>
          <c:if test="${not empty applicationScope.AUTH_WARNING}">
            <div class="warn">${applicationScope.AUTH_WARNING}</div>
          </c:if>
